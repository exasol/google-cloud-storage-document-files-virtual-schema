...
@Tag("integration")
class PerformanceIT {
    private static final GcsTestSetup AWS_S3_TEST_SETUP = new OnlineGcsTestSetup();
    private static IntegrationTestSetup SETUP;

    @BeforeAll
    static void beforeAll() throws Exception {
        // TODO copy + add bucket here
        SETUP = new IntegrationTestSetup(AWS_S3_TEST_SETUP, null);
    }
